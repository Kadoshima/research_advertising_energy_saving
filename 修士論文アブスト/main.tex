...
\section{はじめに}
見守りシステムにおいて，ウェアラブル端末による人間活動認識（HAR）の常時通信は電力消費の主要因である\scite{Luo2021BLENeighborDiscoverySurvey}．
スマートフォンのOS制約に起因する非理想的なスキャン動作は，通信品質（QoS）と消費電力のトレードオフを強める．
本研究はHAR推論の信頼性を通信制御へ接続し，QoS制約下での省電力化を狙う．

\section{研究課題と指標}
固定アドバタイジング間隔には根本的な限界がある．
短間隔はQoSを確保する一方でバッテリ消耗が大きく，長間隔は省電力だが遅延右裾が悪化する\scite{Schrader2016BLEPower}．
