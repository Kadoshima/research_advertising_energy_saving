// TXSD_ModeC2prime_1210.ino
// Read INA219 on TXSD, log ms,mV,uA,p_mW to SD. Start/stop via SYNC (GPIO25 from TX) with optional TICK.
...
// Pins (match TX 1210 wiring)
static const int SD_CS   = 5;
static const int SD_SCK  = 18;
static const int SD_MISO = 19;
static const int SD_MOSI = 23;
static const int SYNC_IN = 26;     // TX GPIO25 -> RX/TXSD SYNC
static const int SYNC_OFF_IN = -1; // unused
static const int TICK_IN = 33;     // TX GPIO27 -> TXSD TICK_IN
...
void setup(){
  Debug.begin(115200);
  Debug.println("[PWR] FW=TXSD_ModeC2prime_1210");
