...
\section{研究目的と主張}
本研究の核となる主張は次のとおりである．HARの推論不確実度に基づくBLEアドバタイジング間隔の適応制御において，単純な閾値ルールでも固定間隔と比較して同等のQoS制約下で平均電力を低減できる運用点（operating point：電力とQoSのトレードオフ上の位置）が存在することを実測で示す．さらに，この知見を安全制約付きコンテキストバンディット（Safe Contextual Bandit）による最適化へ接続するための基盤とする．
