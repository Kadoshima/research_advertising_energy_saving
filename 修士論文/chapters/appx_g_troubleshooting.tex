...
\begin{longtable}{p{0.28\linewidth}p{0.32\linewidth}p{0.34\linewidth}}
  ...
  TL/Poutが不自然に小さい & RXとtruthの時間軸ずれ & 定数オフセット補正を適用したか \\
...
RXログの開始がtruthより遅れる等の理由で，RXの時間軸とtruthの時間軸が一致しない場合がある．このずれを補正しないと，TLや$P_{\mathrm{out}}(\tau)$が過小評価される．本研究では，seqから定数オフセットを推定して補正する手順を採用する（\secref{sec:stress_fixed_metrics}）．
