...
\tabref{tab:policy_table}に，固定とルールベース方策の比較表（例）を示す．
...
\begin{table}[tb]
  ...
  \begin{tabular}{lrrrrrrrrr}
    \toprule
    方策 & share100 & share500 & share1000 & share2000 & PDR\_u & $P_{\mathrm{out}}(1\,\mathrm{s})$ & $TL_{\mathrm{mean}}$[s] & E/adv[μJ] & P[mW] \\
    \midrule
