...
\tabref{tab:policy_table}に，固定とルールベース方策の比較表を示す．表中の各行は固定間隔およびルールベース，各列は滞在比率（share100/500/1000/2000），PDR\_unique，期限超過率$P_{\mathrm{out}}(1\,\mathrm{s})$，平均遅延$TL_{\mathrm{mean}}$，イベントあたりエネルギー（E/adv），および平均電力（P）を表す．
