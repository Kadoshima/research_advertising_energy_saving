...
% 全角数字にしたい場合は２０２５のように入力してください。

% ===== 表紙に出る情報 =====
\newcommand{\ThesisYearLabel}{２０２５年度修士論文}
\newcommand{\ThesisTitleLineOne}{QoS 制約下におけるHAR 不確実度に基づく\\BLE アドバタイジング間隔の適応制御}
\newcommand{\ThesisTitleLineTwo}{}
\newcommand{\ThesisTitle}{\ThesisTitleLineOne\\\ThesisTitleLineTwo}
...
% ===== PDFの修士論文題目ページ(要旨ページ)に出る情報 =====
\newcommand{\AbstractDepartment}{情報工学専攻}
\newcommand{\ThesisTitleAbstract}{QoS 制約下におけるHAR 不確実度に基づくBLE アドバタイジング間隔の適応制御}
