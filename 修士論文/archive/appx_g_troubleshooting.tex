...
\subsection{代表的トラブル}
\noindent アドバタイジングOFFの方が消費が大きい($\Delta E<0$)を整理する．
...
\end{itemize}
\noindent TL/Poutの過小評価(開始位相ずれ)を整理する．
...
\noindent UARTデータ化け(数値列への文字混入)を整理する．
...
\end{itemize}
\noindent SD I/O失敗(open/init)を整理する．
