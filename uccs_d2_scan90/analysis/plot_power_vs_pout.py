#!/usr/bin/env python3
"""
Plot D2/D2b tradeoff: P_out(1 s) vs average power with rho-hat annotation.
...
def main() -> None:
    ...
    eps = 0.1
    ax.axvline(eps, color="#9ca3af", linestyle="--", linewidth=1.6, zorder=0)
    ax.axvspan(ax.get_xlim()[0], eps, color="#d1fae5", alpha=0.18, zorder=0)
    ax.text(eps, ax.get_ylim()[1] * 0.98, r"$\epsilon=0.10$", ha="right", va="top", fontsize=9, color="#6b7280")
