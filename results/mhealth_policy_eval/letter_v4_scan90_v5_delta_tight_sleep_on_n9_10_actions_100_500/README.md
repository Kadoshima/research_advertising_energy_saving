# レター用 δ帯（tight, scan90 v5 / actions={100,500}）

- 生成日: 2025-12-14 (JST)
- 目的: **実機を100↔500のみで動かす前提**で、`Fixed 500ms` が満たさない厳しめの δ帯（例: 0.03）に対して、`Fixed 100ms` より低電力で制約を満たせる点を図で固定する。

## 入力
- Pareto sweep（U+CCS, power table + context mixing, actions=100/500）: `results/mhealth_policy_eval/pareto_front_v8_power_table_scan90_v5_sleep_on_n9_10_actions_100_500/pareto_sweep.csv`
...
MPLBACKEND=Agg XDG_CACHE_HOME=results/mhealth_policy_eval/.cache MPLCONFIGDIR=results/mhealth_policy_eval/.mplconfig \
  .venv_mhealth310/bin/python scripts/plot_letter_delta_band.py \
    --pareto-csv results/mhealth_policy_eval/pareto_front_v8_power_table_scan90_v5_sleep_on_n9_10_actions_100_500/pareto_sweep.csv \
    ...
    --out-dir results/mhealth_policy_eval/letter_v4_scan90_v5_delta_tight_sleep_on_n9_10_actions_100_500
```
