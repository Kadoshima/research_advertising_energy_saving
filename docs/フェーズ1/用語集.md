...
- ΔE/adv（イベントあたりのエネルギー増分, Energy delta per event）: ΔE/adv = (E_ON − E_OFF) / N_adv [mJ/adv]。測定系のベース負荷を相殺して、無線1回あたりの純粋なエネルギー増分を評価する主指標。
...
- Opportunistic Scan（オポチュニスティックスキャン）: OSが他アプリと共有するスキャン。実効スキャンウィンドウが非定常であり、端末単位でのトレース取得と端末内A/B比較が必須となる。
