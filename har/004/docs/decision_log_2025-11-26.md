...
- 2025-11-26 TinyMLアーティファクト v1 確定: TFLite int8 = har/004/export/acc_v1_keras/phase0-1-acc.v1.int8.tflite (sha256=e1c3ff0042badac5dd9bb478a17fac79991736c813143b45e5cb981d9db68610)。PTQ: rep_data.npy(2000窓, 100x3, float32)。PyTorch vs TFLite 比較: argmax一致 0.98, max_prob MAE 0.0277（200サンプル, subject01）。Manifest: har/004/export/acc_v1_keras/manifest.json。
