// RX_UCCS_D1_SCAN90.ino (uccs_d1_scan90)
// Receive TX_UCCS_D1 packets (MFD "<tx_elapsed_ms>_<label>") and log to SD.
...
struct RxEntry {
  uint32_t ms;
  int8_t   rssi;
  uint16_t seq;       // tx_elapsed_ms (0..65535)
  char     label[12]; // e.g., F100/P500
  char     addr[18];
  char     mfd[24];
};
...
static File f;
static const char FW_TAG[] = "RX_UCCS_D1_SCAN90";
...
void setup() {
  Serial.begin(115200);
  Serial.println("[RX] FW=RX_UCCS_D1_SCAN90");
