...
static const char FW_TAG[] = "RX_CCS_E2";
static const char FW_BUILD[] = "RX_CCS_E2_2026-01-21";
...
static const uint32_t TRIAL_MS_FALLBACK = 700000;
...
static void endTrialWithReason(const char* reason) {
  ...
  Serial.printf("[AGENT] RX diag4 trial=%lu nameHit=%lu name=%s\n",
                (unsigned long)trialIndex, (unsigned long)nameHit, TX_NAME);
